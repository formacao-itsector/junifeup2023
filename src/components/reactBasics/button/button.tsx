...
*/
export const NamedExportButton = () => {
  return (
    <div className="flex flex-col items-center gap-4">
      <h3 className="font-bold text-2xl">Named Export</h3>

      <button className="border-2 border-violet-700 rounded-3xl font-bold text-lg px-[2.5rem] py-2 flex items-center justify-center transition-all hover:px-[2rem] hover:border-violet-700 focus:bg-violet-700">
        Export
      </button>
    </div>
  );
